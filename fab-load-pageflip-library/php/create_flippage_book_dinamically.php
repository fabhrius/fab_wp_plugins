...
function pageflip_shortcode($atts) {
    ...
    $arrayImagePath = getArrayImagePath();

    $pages_string = createPagesString($arrayImagePath);
...
function createPagesString($arrayImagePath){
    $output = '';

    foreach($arrayImagePath as $key => $value){
        $output .= createPageString($value);
    }
    return $output;
}

function createPageString($imagePath){
...
function getArrayImagePath(){
    ...
    //$arrayimagepaths = ($img1, $img2, $img3, $img4);

    $arrayimagepaths[0] = $img1;
    $arrayimagepaths[1] = $img2;
    $arrayimagepaths[2] = $img3;
    $arrayimagepaths[3] = $img4;
